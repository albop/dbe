...
We construct the __confidence interval__: $$I^{\alpha} = [\hat{\beta}-t\sigma(\hat{\beta}), \hat{\beta}+t\sigma(\hat{\beta})]$$
...
- we can say the true value is within the interval with 95% _confidence level_
...
- Crude homicide rate:  \(\hat\beta = 9.2\) (p < 0.001), corr = 0.74  
- Excluding the U.S.:   \(\hat\beta = 4.9\) (p = 0.003), corr = 0.57
...
::: {.small}
⚠️ **Caution (OLS lesson):** This is **not causal** (possible confounding, reverse causality, measurement error). Use it to practice interpreting \(\hat\beta\), p-values, and thinking about omitted variables.
:::

::: {.footer}
Source: Hemenway, D. & Miller, M. (2000). *Firearm Availability and Homicide Rates across 26 High-Income Countries*. **Journal of Trauma**, 49(6), 985–988. [Paper](./FirearmAvailabilityVsHomicideRates.pdf.crdownload)
:::