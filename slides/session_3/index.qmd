...
![](graphs/regression_uncertainty_1.png){.fragment .current-visible data-fragment-index=1 width=100%}

![](graphs/regression_uncertainty_2.png){.fragment .current-visible data-fragment-index=2 width=100%}

![](graphs/regression_uncertainty_3.png){.fragment .current-visible data-fragment-index=3 width=100%}
...
![](graphs/random_estimates_1.png){.fragment .current-visible data-fragment-index=2}

![](graphs/random_estimates_2.png){.fragment .current-visible data-fragment-index=3}

![](graphs/random_estimates_3.png){.fragment .current-visible data-fragment-index=4}

![](graphs/random_estimates_4.png){.fragment .current-visible data-fragment-index=5}

![](graphs/random_estimates_5.png){.fragment .current-visible data-fragment-index=6}

![](graphs/random_estimates_6.png){.fragment .current-visible data-fragment-index=7}

![](graphs/random_estimates_7.png){.fragment .current-visible data-fragment-index=8}

![](graphs/random_estimates_8.png){.fragment .current-visible data-fragment-index=9}

![](graphs/random_estimates_9.png){.fragment .current-visible data-fragment-index=10}

![](graphs/random_estimates_10.png){.fragment .current-visible data-fragment-index=11}

![](graphs/random_estimates_100.png){.fragment .current-visible data-fragment-index=12}
