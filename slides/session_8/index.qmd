...
- Recently, *deep learning* (and [GPT-4](https://gpt3examples.com/#examples)) has changed this state of facts:
...
- We can the train the model:  $y = x_1 fw_1 + \cdots x_K w_K$ where $y$ is the sentiment and $w_i$ is wordcount of word $w_i$
