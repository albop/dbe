...
We need some hypotheses on the <em>data generation process</em>:
...
::::: {.callout-note title="Fisher Criterium (F-test)"}
...
::::: {.fragment}
One can produce a <mark>p-value</mark>.
...
::::: {.callout-note title="Student Test"}
...
$$t = \frac{\hat{\beta_k}}{\hat{\sigma}(\hat{\beta_k})}$$
...
Or just look at the <mark>p-value</mark>:
...
- estimated $\hat{\beta_1}$ will have a bias (__omitted variable bias__)
...
__Method 1__ : remove coefficients with lowest t (less significant) to maximize adjusted R-squared
...
__Method 2__ : choose combination to maximize Akaike Information Criterium
